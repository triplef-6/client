...
export const SelectTourFormatTrigger = React.forwardRef<
...
>((
    ...
    return (
        <div className={containerStyles}>
            <SelectGroup>
                <SelectLabel className={placeholderStyles}>Формат</SelectLabel>
            </SelectGroup>
            <SelectPrimitive.Trigger ref={ref} className={cn(triggerStyles, className)} {...props}>
                <UserCog className={iconStyles}/>
                <SelectGroup>
...
SelectTourFormatTrigger.displayName = SelectPrimitive.Trigger.displayName