...
export const SelectTourFormatBehaviorTrigger = React.forwardRef<
...
>((
    ...
    return (
        <div className={containerStyles}>
            <SelectGroup>
                <SelectLabel className={placeholderStyles}>Формат проведения</SelectLabel>
            </SelectGroup>
            <SelectPrimitive.Trigger ref={ref} className={cn(triggerStyles, className)} {...props}>
                <Footprints className={iconStyles}/>
                <SelectGroup>
...
SelectTourFormatBehaviorTrigger.displayName = SelectPrimitive.Trigger.displayName