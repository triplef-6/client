...
const schema = z
    .string()
    .min(10, "Описание на может содержать меньше 10 символов")
    .max(200, "Описание на может содержать больше 200 символов")
...
export const MyInfoInput = React.forwardRef<HTMLInputElement, InputProps>(
    ({
         className,
         type,
         defaultValue,
...
MyInfoInput.displayName = "MyInfoInput"