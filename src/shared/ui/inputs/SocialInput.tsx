...
export const SocialInput = React.forwardRef<HTMLInputElement, InputProps>((
    {
        className,
        type,
        label,
    ...
    const iconSearchStyles: string = [
        ...
        !field.isCorrected ? "text-secondary-red" : "text-gray-500"
    ].join(" ");
    ...
    const inputStyles = [
        ...
        !field.isCorrected ? "border border-secondary-red focus:border-secondary-red text-secondary-red bg-red-100 hover:bg-red-100" : "",
    ...
    const labelStyles = [
        ...
        !field.isCorrected ? "text-secondary-red" : "text-grayscale-400"
    ].join(" ")
